...
Gerando novamente o código VHDL a partir do modelo modificado para múltiplas peças, foi necessário, criar um compoenente relacionado com o display de 7 segmentos que nos permiter ver quantas caixas estão presentes em cada tapete durante o decorrer do programa.
