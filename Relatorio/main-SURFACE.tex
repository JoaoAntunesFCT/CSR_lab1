...
\input{sections/radiosim}
\clearpage

\input{sections/spicesim}
\clearpage

\input{sections/medicoes}
\clearpage

\input{sections/experiencia_rffe}
\clearpage

\input{sections/conlusao}
\clearpage
...
% --- Apêndice ---
\appendix
% \input{apendix/appendix}  % Descomente se tiver conteúdo no apêndice
