...
End Lab3_P8_Corrigido;

Architecture Structural OF Lab3_P8_Corrigido IS
    ...
    Signal event_ini_3: STD_LOGIC := '0';
    ...
    Begin
      If rising_edge(Clk) Then
        ...
        Elsif Enable='1' Then
          ...
          -- Bot2 action on place Processar Peca_2(p_89_6)
          If p_89_6 > 0 Then
            exp_res := 1;
            If (TRUE)
              Then new_value := exp_res;
          ...
          -- Bot3 action on place Processar Peca_3(p_90_6)
          If p_90_6 > 0 Then
            exp_res := 1;
            If (TRUE)
              Then new_value := exp_res;
