...
REM
REM Generated by Vivado on Tue Oct 14 19:08:35 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_CSR_Lab3_Part4_vhdl.prj"
call xvhdl  --incr --relax -prj tb_CSR_Lab3_Part4_vhdl.prj -log xvhdl.log
