...
Architecture Structural OF CSR_Lab3_Part4 IS

    Signal p_2: INTEGER RANGE 0 TO 1 := 1;
    Signal p_5: INTEGER RANGE 0 TO 1 := 0;
    Signal p_10: INTEGER RANGE 0 TO 1 := 1;
    Signal p_13: INTEGER RANGE 0 TO 1 := 0;
    Signal p_18: INTEGER RANGE 0 TO 1 := 1;
    Signal p_21: INTEGER RANGE 0 TO 1 := 0;
    Signal p_26: INTEGER RANGE 0 TO 1 := 1;
    Signal p_29: INTEGER RANGE 0 TO 1 := 0;
    Signal p_34: INTEGER RANGE 0 TO 1 := 1;
    Signal p_37: INTEGER RANGE 0 TO 1 := 0;
    Signal p_42: INTEGER RANGE 0 TO 1 := 1;
    Signal p_45: INTEGER RANGE 0 TO 1 := 0;
    Signal p_50: INTEGER RANGE 0 TO 1 := 1;
    Signal p_53: INTEGER RANGE 0 TO 1 := 0;
    Signal p_58: INTEGER RANGE 0 TO 1 := 1;
    Signal p_61: INTEGER RANGE 0 TO 1 := 0;
    Signal p_66: INTEGER RANGE 0 TO 1 := 1;
    Signal p_69: INTEGER RANGE 0 TO 1 := 0;
    Signal p_74: INTEGER RANGE 0 TO 1 := 1;
    Signal p_77: INTEGER RANGE 0 TO 1 := 0;
    Signal p_82: INTEGER RANGE 0 TO 1 := 1;
    Signal p_85: INTEGER RANGE 0 TO 1 := 0;
    Signal p_90: INTEGER RANGE 0 TO 1 := 1;
    Signal p_93: INTEGER RANGE 0 TO 1 := 0;
    Signal p_98: INTEGER RANGE 0 TO 1 := 1;
    Signal p_101: INTEGER RANGE 0 TO 1 := 0;
...
Begin
    ...
    proc_transitions: PROCESS( Clk, Enable, Reset ) IS
      ...
      Variable p_13_add, p_13_avail : INTEGER RANGE 0 to 1;
      Variable p_18_add, p_18_avail : INTEGER RANGE 0 to 1;
      Variable p_21_add, p_21_avail : INTEGER RANGE 0 to 1;
      Variable p_26_add, p_26_avail : INTEGER RANGE 0 to 1;
      Variable p_29_add, p_29_avail : INTEGER RANGE 0 to 1;
      Variable p_34_add, p_34_avail : INTEGER RANGE 0 to 1;
      Variable p_37_add, p_37_avail : INTEGER RANGE 0 to 1;
      Variable p_42_add, p_42_avail : INTEGER RANGE 0 to 1;
      Variable p_45_add, p_45_avail : INTEGER RANGE 0 to 1;
      Variable p_50_add, p_50_avail : INTEGER RANGE 0 to 1;
      ...
      Variable p_66_add, p_66_avail : INTEGER RANGE 0 to 1;
      Variable p_69_add, p_69_avail : INTEGER RANGE 0 to 1;
      Variable p_74_add, p_74_avail : INTEGER RANGE 0 to 1;
      Variable p_77_add, p_77_avail : INTEGER RANGE 0 to 1;
      Variable p_82_add, p_82_avail : INTEGER RANGE 0 to 1;
      Variable p_85_add, p_85_avail : INTEGER RANGE 0 to 1;
      Variable p_90_add, p_90_avail : INTEGER RANGE 0 to 1;
      Variable p_93_add, p_93_avail : INTEGER RANGE 0 to 1;
      Variable p_98_add, p_98_avail : INTEGER RANGE 0 to 1;
      Variable p_101_add, p_101_avail : INTEGER RANGE 0 to 1;
    Begin
      If Reset = '1' Then
          p_2 <= 1;
          p_5 <= 0;
