...
Architecture Structural OF CSR___Lab2___Part1 IS
    ...
    Signal p_14: INTEGER RANGE 0 TO 1 := 0;
    Signal p_19: INTEGER RANGE 0 TO 1 := 0;
    Signal p_20: INTEGER RANGE 0 TO 1 := 0;
    Signal p_22: INTEGER RANGE 0 TO 1 := 0;
    Signal p_24: INTEGER RANGE 0 TO 1 := 0;
    Signal p_59: INTEGER RANGE 0 TO 1 := 0;
    Signal p_69: INTEGER RANGE 0 TO 1 := 1;
    Signal p_70: INTEGER RANGE 0 TO 1 := 1;
...
Begin
    ...
    proc_transitions: PROCESS( Clk, Enable, Reset ) IS
      ...
      Variable p_19_add, p_19_avail : INTEGER RANGE 0 to 1;
      Variable p_20_add, p_20_avail : INTEGER RANGE 0 to 1;
      Variable p_22_add, p_22_avail : INTEGER RANGE 0 to 1;
      ...
      Variable p_70_add, p_70_avail : INTEGER RANGE 0 to 1;
    Begin
      If Reset = '1' Then
          p_2 <= 1;
          p_3 <= 0;
